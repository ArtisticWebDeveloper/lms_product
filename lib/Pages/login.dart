          ...
          child: Column(
            ...
            children: [
              ...
              Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                Text("forget password? ",style: TextStyle(color: Colors.grey,fontFamily: 'Poppins'),),
                InkWell(
                    onTap: () {},
                    child: const Text(
                      'Get Help',
                      style: TextStyle(
                          color: Colors.black, fontWeight: FontWeight.bold, fontFamily: 'Poppins'),
                    ))
              ]),
              const SizedBox(height: 20),
              const Row(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text('OR', style: TextStyle(color: Colors.grey, fontFamily: 'Poppins')),
                  ),
                  Expanded(
                    child: Divider(
                      color: Colors.grey,
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Text("Don't have an Account?",style: TextStyle(color: Colors.grey,fontFamily: 'Poppins'),),
                  InkWell(
                    onTap: (){
